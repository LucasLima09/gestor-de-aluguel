...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  late Future<List<MensalidadeModel>> _futurePendencias;
  ...
  void _carregarDados() {
    ...
    _futurePendencias = _mensalidadeRepository.buscarMensalidadesPendentes(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          FutureBuilder<List<MensalidadeModel>>(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData && snapshot.data!.isNotEmpty) {
                return PendenciasBanner(
                  pendencias: snapshot.data!,
                  onTap: () async {
          ...
          Expanded(
            child: FutureBuilder<List<ImovelModel>>(
